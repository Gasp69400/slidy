  ...
  return (
    <section className="relative overflow-hidden">
      ...
      >
        ...
        <div className="absolute left-1/2 top-0 h-[520px] w-[920px] -translate-x-1/2 rounded-[100%] bg-gradient-to-b from-brand-200/65 via-brand-100/35 to-transparent blur-3xl dark:from-brand-950/45 dark:via-brand-950/20 dark:to-transparent" />
        <div className="absolute -right-28 top-32 h-[22rem] w-[22rem] rounded-full bg-brand-300/35 blur-3xl dark:bg-brand-800/22" />
        <div className="absolute -left-24 top-[22rem] h-72 w-72 rounded-full bg-brand-200/35 blur-3xl dark:bg-brand-900/14" />
      </div>
      ...
      <div className="mx-auto max-w-6xl px-4 pb-20 pt-10 sm:px-6 lg:px-8 lg:pb-28 lg:pt-16">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4">
            <Button
              size="lg"
              className="h-12 min-w-[200px] rounded-full border border-brand-700/20 bg-gradient-to-r from-brand-600 to-brand-700 px-8 text-base font-semibold text-white shadow-xl shadow-brand-600/30 transition hover:from-brand-500 hover:to-brand-600 hover:shadow-brand-600/35"
              asChild
            >
              <Link href="/studio">
            ...
            <Button
              size="lg"
              variant="outline"
              className="h-12 min-w-[200px] rounded-full border-brand-200/90 bg-white/90 px-8 text-base font-semibold text-slate-800 shadow-md shadow-slate-200/60 backdrop-blur-sm hover:border-brand-300 hover:bg-brand-50/80 dark:border-white/14 dark:bg-slate-900/60 dark:text-slate-100 dark:hover:border-brand-400/70 dark:hover:bg-slate-800/80"
              asChild
            >
          ...
          <div className="mt-6 flex flex-col items-center gap-4">
            {isPending ? (
              <span
                ...
                aria-busy="true"
              >
                <Sparkles className="h-3.5 w-3.5 animate-pulse text-brand-400" aria-hidden />
                {t('home.hero.cta_cv')}
              </span>
            ) : (
              <Link
            ...
            <Link
              href="#pricing"
              className="text-xs font-medium uppercase tracking-wider text-slate-400 transition hover:text-brand-600 dark:text-slate-500 dark:hover:text-brand-400"
            >
              {t('landing.pricing')}
            </Link>
          </div>
        ...
        <div className="mx-auto mt-16 max-w-4xl sm:mt-20">
          <div className="rounded-[1.35rem] border border-slate-200/70 bg-white/75 p-[7px] shadow-[0_24px_60px_-20px_rgba(255,118,0,0.22)] ring-1 ring-brand-200/35 backdrop-blur-md dark:border-slate-700/70 dark:bg-slate-900/70 dark:shadow-black/55 dark:ring-brand-500/15">
            ...
            <div className="mt-2 grid gap-2 rounded-2xl bg-gradient-to-br from-slate-900 via-[#1a1208] to-brand-950 p-4 sm:grid-cols-[1fr_1.35fr] sm:p-5">
              <div className="flex flex-col justify-between rounded-2xl border border-white/10 bg-white/5 p-4 text-left">
                ...
                <div className="mt-6 flex flex-wrap gap-2">
                  {tags.map((tag) => (
                    <span
                      key={tag}
                      className="rounded-full bg-white/10 px-3 py-1 text-[11px] text-brand-100"
                    >
                      {tag}
                    </span>
                  ))}
              ...
              <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-slate-950/50 p-4">
                <div className="mb-3 flex items-center justify-between text-[10px] text-slate-400">
                  ...
                  <SlidyLogoMark size="xs" className="shadow-md shadow-brand-900/40" />
                </div>
                ...
                <Wand2 className="absolute bottom-3 right-3 h-8 w-8 text-brand-400/40" />
              </div>
            </div>
          </div>
        </div>
...
function HomeStatsSection() {
  ...
  return (
    <div className="mx-auto mt-10 max-w-4xl">
      <div className="overflow-hidden rounded-[1.25rem] border border-slate-200/75 bg-white/80 shadow-lg shadow-brand-500/[0.06] ring-1 ring-slate-200/55 backdrop-blur-sm dark:border-slate-700/80 dark:bg-slate-900/65 dark:ring-white/8">
        <div className="grid divide-y divide-slate-100 sm:grid-cols-3 sm:divide-x sm:divide-y-0 dark:divide-slate-700/90">
          <div className="relative p-5 text-center sm:text-left">
            <div className="mb-3 inline-flex rounded-xl bg-brand-500/[0.12] p-2 ring-1 ring-brand-500/15 dark:bg-brand-400/15">
              <FileStack className="h-5 w-5 text-brand-600 dark:text-brand-300" aria-hidden />
            </div>
          ...
          <div className="relative p-5 text-center sm:text-left">
            <div className="mb-3 inline-flex rounded-xl bg-brand-500/12 p-2 ring-1 ring-brand-500/18 dark:bg-brand-400/14">
              <Briefcase className="h-5 w-5 text-brand-600 dark:text-brand-300" aria-hidden />
            </div>
            <p className="text-[10px] font-semibold uppercase tracking-[0.16em] text-slate-500 dark:text-slate-400">
          ...
          {steps.map((step, i) => (
            <li
              ...
              className={cn(
                ...
                'hover:-translate-y-1 hover:border-brand-200/80 hover:shadow-[0_22px_50px_-28px_rgba(255,118,0,0.28)] dark:border-white/10 dark:bg-slate-900/80 dark:hover:border-brand-400/35',
              )}
            >
              <span
                className="pointer-events-none absolute -right-0.5 -top-6 text-[4.65rem] font-bold leading-none tabular-nums text-brand-100 transition group-hover:text-brand-50/98 dark:text-brand-500/[0.12] dark:group-hover:text-brand-400/18"
              >
                {String(i + 1).padStart(2, '0')}
              </span>
              <div className="relative z-[1] mb-4 inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-brand-50 to-white shadow-inner ring-1 ring-brand-200/55 dark:from-brand-950/85 dark:to-slate-900 dark:ring-brand-500/25">
                <step.icon className="h-6 w-6 text-brand-600 dark:text-brand-300" />
              </div>
          ...
          {items.map((item) => (
            <div
              ...
              className={cn(
                ...
                'before:pointer-events-none before:absolute before:inset-x-7 before:top-0 before:h-px before:rounded-full before:bg-gradient-to-r before:from-transparent before:via-brand-400/45 before:to-transparent',
                'hover:-translate-y-0.5 hover:border-brand-200/80 hover:shadow-[0_20px_44px_-28px_rgba(255,118,0,0.22)] dark:border-white/10 dark:bg-slate-900/75 dark:hover:border-brand-400/30',
              )}
            >
...
function HomePricingSection() {
  ...
  return (
    <section
      id="pricing"
      className="relative overflow-hidden border-y border-slate-200/70 bg-gradient-to-b from-white via-brand-50/25 to-slate-50/90 py-16 dark:border-slate-800/80 dark:from-[#0e0d12] dark:via-[#120f18] dark:to-[#09090b]"
    >
      <div
        aria-hidden
        className="pointer-events-none absolute -left-28 top-20 h-[22rem] w-[22rem] rounded-full bg-brand-400/14 blur-[100px] dark:bg-brand-600/14"
      />
      <div
        aria-hidden
        className="pointer-events-none absolute -right-20 bottom-0 h-80 w-80 rounded-full bg-brand-400/18 blur-[100px] dark:bg-brand-600/14"
      />
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
        ...
        <div className="relative mt-3 text-center">
          <Link
            href="/pricing"
            className="inline-flex items-center gap-1.5 rounded-full px-4 py-1.5 text-xs font-semibold text-brand-700 ring-1 ring-brand-200/85 transition hover:bg-brand-50 dark:text-brand-300 dark:ring-brand-500/25 dark:hover:bg-brand-950/55 sm:text-sm"
          >
...
function FooterCTA() {
  ...
  return (
    <section className="relative isolate overflow-hidden border-t border-white/15 bg-gradient-to-br from-brand-600 via-brand-600 to-brand-600 py-20 dark:border-white/10">
      <div
        aria-hidden
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute bottom-[-50%] right-[-15%] h-[26rem] w-[26rem] rounded-full bg-brand-400/33 blur-[100px]"
      />
      ...
      <div className="relative mx-auto max-w-3xl px-4 pb-6 pt-2 text-center sm:px-6">
        ...
        <div className="mx-auto mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4">
          <Button
            size="lg"
            className="h-12 min-w-[220px] rounded-full border border-white/20 bg-white px-8 text-base font-semibold text-brand-700 shadow-xl shadow-brand-900/35 transition hover:bg-slate-50"
            asChild
          >
