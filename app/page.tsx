...
function HomePricingSection() {
  ...
  return (
    <section
      id="pricing"
      className="border-y border-slate-200/80 bg-gradient-to-b from-slate-50/90 via-white to-slate-50/50 py-20 dark:border-slate-800 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950"
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-3">
          {tiers.map((tier) => (
            ...
            >
              {tier.highlighted ? (
                <div className="absolute -top-3 left-1/2 z-10 -translate-x-1/2 whitespace-nowrap rounded-full bg-violet-600 px-3 py-0.5 text-xs font-semibold text-white">
                  {t('pricing.popular')}
                </div>
              ) : null}
              <CardHeader>
                ...
                <CardDescription className="min-h-[2.75rem] text-left text-sm text-slate-600 dark:text-slate-900">
                  {tier.description}
                </CardDescription>
                <div className="mt-4 flex flex-wrap items-baseline gap-1">
                  ...
                  <span className="text-sm font-medium text-slate-500 dark:text-slate-700">
                    €
                  </span>
              ...
              <CardContent>
                <p className="mb-3 text-[11px] font-semibold uppercase tracking-wide text-slate-400 dark:text-slate-700">
                  {t('home.pricing.includes')}
                </p>
                <ul className="space-y-3 text-sm text-slate-600 dark:text-slate-900">
                  {tier.features.map((f) => (
                    <li key={f} className="flex gap-2">
                      <Check className="mt-0.5 h-4 w-4 shrink-0 text-violet-600 dark:text-violet-600" />
                      <span>{f}</span>
                    </li>
                  ))}
                </ul>
