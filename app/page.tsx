  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto mt-14 grid max-w-5xl grid-cols-1 items-stretch gap-6 sm:grid-cols-3 sm:gap-4 lg:gap-8">
          {tiers.map((tier) => {
                  ...
                  <div className="relative flex flex-1 flex-col px-6 pb-6 pt-7 sm:px-7 sm:pb-7 sm:pt-8">
                    <div className="flex items-start justify-between gap-3">
                      ...
                      {accent ? (
                        ...
                        <span className="h-px w-8 shrink-0 bg-slate-200/90 dark:bg-white/15" aria-hidden />
                      )}
                    </div>
