...
-- Stocke les CV générés côté API (client anon + JWT utilisateur, sans Prisma).
-- Script idempotent :
-- - renomme une éventuelle table legacy `public.cv_document` -> `public.cv_documents`
-- - crée `public.cv_documents` dans le schéma public si absente
-- - ajoute les colonnes manquantes pour compatibilité.
