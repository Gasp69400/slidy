...
export const CV_TEMPLATES: CvTemplateDef[] = [
  {
    ...
    previewClass: 'bg-gradient-to-br from-indigo-50 via-white to-violet-50',
  ...
  },
  {
    ...
    previewClass: 'bg-gradient-to-b from-white to-slate-50',
  ...
  },
  {
    ...
    previewClass: 'bg-gradient-to-br from-slate-900 via-slate-950 to-indigo-950',
  ...
  },
  {
    ...
    previewClass: 'bg-gradient-to-br from-slate-100 to-slate-200',
  ...
  },
  {
    ...
    previewClass: 'bg-gradient-to-br from-slate-50 to-slate-200 border-b-4 border-slate-800',
  ...
  },
  {
    ...
    previewClass: 'bg-white border border-slate-200 shadow-sm',
    shellClass: 'bg-white text-slate-900 border border-slate-200',
    headerClass: '',
    sidebarClass: '',
  },
